...
while True:
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # v2 /////////////////////////# --- Calcula el centre de la mà i envia per OSC ---////////////////////////////////////
            ...
            # v3 ////////////////////////////# --- Calcula el GEST de la mà i envia per OSC ---///////////////////////////////////////////
            gesture = "open"
            if distance < 40: 
                gesture = "pinch"
            client.send_message("/hand/gesture", gesture)
            cv2.putText(img, f'Gesture: {gesture}', (10, 170),  cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0, 255, 255), 2)
